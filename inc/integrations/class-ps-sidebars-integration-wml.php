...
add_action( 'cs_integrations', array( 'BenutzerdefinierteSeitenleistenIntegrationWML', 'instance' ) );
/**
 * Integrate sidebar locations with WML
 *
 * @since 3.2.0
 */
class BenutzerdefinierteSeitenleistenIntegrationWML extends BenutzerdefinierteSeitenleistenIntegration {
	...
	public static function instance() {
		...
		if ( null === $instance ) {
			$instance = new BenutzerdefinierteSeitenleistenIntegrationWML();
		}
		return $instance;
	}
	...
	public function prepare( $tabs ) {
		$tabs[ $this->key_name ] = array(
			'title' => __( 'WP Multilang', 'ps-sidebars' ),
