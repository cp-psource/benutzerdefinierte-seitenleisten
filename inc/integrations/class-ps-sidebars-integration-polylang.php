...
add_action( 'cs_integrations', array( 'BenutzerdefinierteSeitenleistenIntegrationPolylang', 'instance' ) );
/**
 * Integrate sidebar locations with Polylang
 *
 * @since 3.1.2
 */
class BenutzerdefinierteSeitenleistenIntegrationPolylang extends BenutzerdefinierteSeitenleistenIntegration {
	...
	public static function instance() {
		...
		if ( null === $instance ) {
			$instance = new BenutzerdefinierteSeitenleistenIntegrationPolylang();
		}
		return $instance;
	}
