 ...
 * helper function
 */
if ( ! function_exists( 'benutzerdefinierte_seitenleisten_col_sideber_not_available' ) ) {
	/**
	 ...
	 */
	function benutzerdefinierte_seitenleisten_col_sideber_not_available( $page_name ) {
		$content = sprintf(
			esc_attr__( 'Nicht verfügbar für %s', 'ps-sidebars' ),
			$page_name
		);
		printf(
			'<small>%s</small>',
 ...
 */
if ( $is_front ) {
	benutzerdefinierte_seitenleisten_col_sideber_not_available( __( 'Startseite', 'ps-sidebars' ) );
} elseif ( $is_blog ) {
	benutzerdefinierte_seitenleisten_col_sideber_not_available( __( 'Blogseite', 'ps-sidebars' ) );
} else if ( $is_woo_shop ) {
	benutzerdefinierte_seitenleisten_col_sideber_not_available( __( 'WooCommerce Shop', 'ps-sidebars' ) );
} else {
