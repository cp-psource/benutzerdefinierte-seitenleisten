...
if ( $print_nonce ) {
	$print_nonce = false;
	wp_nonce_field( 'bulk-edit-cs', 'ps-sidebars-editor-bulk-edit' );
}

?>
<fieldset class="inline-edit-col-left cs-quickedit">
<div class="inline-edit-col">
<label><?php _e( 'PS Seitenleisten', 'ps-sidebars' ); ?></label>
<?php
		...
		<label>
			...
			<select name="cs_replacement_<?php echo esc_attr( $s ); ?>"
				class="cs-replacement-field <?php echo esc_attr( $s ); ?>">
                    <option value="-"><?php _e( '&mdash; Keine Änderung &mdash;', 'ps-sidebars' ); ?></option>
